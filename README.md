...
Autonomous Motion: The robot performs autonomous block manipulation using a three-stage motion sequence: approach, grasp, and retract. This strategy ensures stable and precise handling of objects, allowing the arm to reliably pick up blocks and place them in predefined configurations without manual intervention.
